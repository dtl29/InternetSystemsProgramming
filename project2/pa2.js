...
function emailCheckWhileTyping()
{
	...
	{
		document.getElementById("inputEmail").innerHTML = "<p>Invalid <br/>Please have no extra special characters.<br/>And needs to contain 1 '@' symbol and 1 '.' </p>";	
	}
	else if(str2.match(/^[0-9a-zA-Z]+$/) == null || str2.length < 0)
	{
		document.getElementById("inputEmail").innerHTML = "<p>Invalid <br/>Please have no extra special characters after the '@'.<br/>And needs to contain 1 '@' symbol and 1 '.'  </p>";
	}
	else if((str3.length > 3) || str3.length < 0 || (str3.match(/^[0-9a-zA-Z]+$/) == null))
	{
		document.getElementById("inputEmail").innerHTML = "<p>Invalid<br/>The ending should be no more than 3 charaters long.<br/>Please have no extra special characters.<br/>And needs to contain 1 '@' symbol and 1 '.' </p>";
	}
	else
	{
		document.getElementById("inputEmail").innerHTML = "<p>The entered email is valid</p>";
	}
}
